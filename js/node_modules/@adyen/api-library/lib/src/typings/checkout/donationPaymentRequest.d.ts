...
export declare class DonationPaymentRequest {
    ...
    */
    'entityType'?: DonationPaymentRequest.EntityTypeEnum;
    /**
    ...
    */
    'industryUsage'?: DonationPaymentRequest.IndustryUsageEnum;
...
export declare namespace DonationPaymentRequest {
    enum ChannelEnum {
        IOs = "iOS",
        Android = "Android",
        Web = "Web"
