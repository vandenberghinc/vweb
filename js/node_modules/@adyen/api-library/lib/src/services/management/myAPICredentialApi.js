...
exports.MyAPICredentialApi = void 0;
const getJsonResponse_1 = __importDefault(require("../../helpers/getJsonResponse"));
const service_1 = __importDefault(require("../../service"));
const resource_1 = __importDefault(require("../resource"));
const models_1 = require("../../typings/management/models");
class MyAPICredentialApi extends service_1.default {
    constructor(client) {
        super(client);
    ...
    */
    async removeAllowedOrigin(originId, requestOptions) {
    ...
    */
    async getApiCredentialDetails(requestOptions) {
        const endpoint = `${this.baseUrl}/me`;
        const resource = new resource_1.default(this, endpoint);
        const response = await (0, getJsonResponse_1.default)(resource, "", { ...requestOptions, method: "GET" });
        return models_1.ObjectSerializer.deserialize(response, "MeApiCredential");
    }
    /**
    ...
    */
    async getAllowedOrigins(requestOptions) {
    ...
    */
    async getAllowedOriginDetails(originId, requestOptions) {
        const endpoint = `${this.baseUrl}/me/allowedOrigins/{originId}`
            .replace("{" + "originId" + "}", encodeURIComponent(String(originId)));
        const resource = new resource_1.default(this, endpoint);
        const response = await (0, getJsonResponse_1.default)(resource, "", { ...requestOptions, method: "GET" });
    ...
    * @return {@link AllowedOrigin }
    */
    async addAllowedOrigin(createAllowedOriginRequest, requestOptions) {
        const endpoint = `${this.baseUrl}/me/allowedOrigins`;
        const resource = new resource_1.default(this, endpoint);
        const request = models_1.ObjectSerializer.serialize(createAllowedOriginRequest, "CreateAllowedOriginRequest");
        const response = await (0, getJsonResponse_1.default)(resource, request, { ...requestOptions, method: "POST" });
        return models_1.ObjectSerializer.deserialize(response, "AllowedOrigin");
    }
}
exports.MyAPICredentialApi = MyAPICredentialApi;
//# sourceMappingURL=myAPICredentialApi.js.map