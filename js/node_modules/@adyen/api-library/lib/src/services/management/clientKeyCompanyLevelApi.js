...
exports.ClientKeyCompanyLevelApi = void 0;
const getJsonResponse_1 = __importDefault(require("../../helpers/getJsonResponse"));
const service_1 = __importDefault(require("../../service"));
const resource_1 = __importDefault(require("../resource"));
const models_1 = require("../../typings/management/models");
class ClientKeyCompanyLevelApi extends service_1.default {
    constructor(client) {
        super(client);
    ...
    */
    async generateNewClientKey(companyId, apiCredentialId, requestOptions) {
...
exports.ClientKeyCompanyLevelApi = ClientKeyCompanyLevelApi;
//# sourceMappingURL=clientKeyCompanyLevelApi.js.map