...
exports.ClientKeyMerchantLevelApi = void 0;
const getJsonResponse_1 = __importDefault(require("../../helpers/getJsonResponse"));
const service_1 = __importDefault(require("../../service"));
const resource_1 = __importDefault(require("../resource"));
const models_1 = require("../../typings/management/models");
class ClientKeyMerchantLevelApi extends service_1.default {
    constructor(client) {
        super(client);
    ...
    */
    async generateNewClientKey(merchantId, apiCredentialId, requestOptions) {
        ...
        return models_1.ObjectSerializer.deserialize(response, "GenerateClientKeyResponse");
    }
}
exports.ClientKeyMerchantLevelApi = ClientKeyMerchantLevelApi;
//# sourceMappingURL=clientKeyMerchantLevelApi.js.map