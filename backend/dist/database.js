...
class Collection {
        ...
        if (Array.isArray(indexes) && indexes.length > 0) {
            for (const index of indexes) {
                this.create_index({
                    ...
                    commit_quorom: index.commit_quorom,
                    forced: index.forced,
                });
            }
        }
    ...
    // Chunked methods.
    _load_chunked(path, find_opts) {
        return __awaiter(this, void 0, void 0, function* () {
            let query = typeof path === "string" ? { _path: path, chunk: { $gte: 0 } } : Object.assign(Object.assign({}, path), { chunk: { $gte: 0 } });
            const chunks_cursor = this.col.find(query, find_opts).sort({ chunk: 1 });
            const chunks = yield chunks_cursor.toArray();
            if (chunks.length === 0) {
                return null;
            }
    ...
    _save_chunked(path, content) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const ref_query = typeof path === "string" ? { _path: path, chunk: -1 } : Object.assign(Object.assign({}, path), { chunk: -1 });
            const object_ref = yield this.col.findOne(ref_query);
            ...
            for (let i = 0; i < buffer.length; i += Collection.chunk_size) {
                ...
                if (typeof path === "string") {
                    ...
                    query = Object.assign(Object.assign({}, path), { chunk: i / Collection.chunk_size });
                    update = {
                        chunk: i / Collection.chunk_size,
                        data: buffer.slice(i, i + Collection.chunk_size)
                    };
            ...
            // Write.
            yield this.col.bulkWrite(bulk_ops, { ordered: true });
            ...
            if (new_chunk_count < old_chunk_count) {
                ...
                yield this.col.deleteMany(ref_query);
            }
        });
    }
    // Create index.
     ...
     */
    create_index(_a) {
        return __awaiter(this, arguments, void 0, function* ({ keys, options = null, commit_quorum = null, forced = false }) {
            var _b;
            let keys_obj = keys;
            if (typeof keys === "string") {
                keys_obj = {};
                keys_obj[index.key] = 1;
            }
            ...
            if (forced) {
                try {
                    yield this.col.dropIndex((_b = options === null || options === void 0 ? void 0 : options.name) !== null && _b !== void 0 ? _b : Object.entries(keys_obj).map(([key, value]) => `${key}_${value}`).join('_'));
                }
                catch (err) {
                    if (err.codeName !== 'IndexNotFound') {
                        throw err;
            ...
            // Create index.
            return yield this.col.createIndex(keys_obj, options, commit_quorum);
        });
    }
    // Find.
    /*  @docs:
    ...
    find(query) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return this._process_doc(yield this.col.findOne(query));
            }
            catch (error) {
                console.error(error);
    ...
    exists(path) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const doc = yield this.col.findOne(typeof path === "object" ? path : { _path: path }, { projection: { _id: 1 } });
                return doc != null;
            }
            catch (error) {
                console.error(error);
     ...
     */
    load(path_1) {
        return __awaiter(this, arguments, void 0, function* (path, opts = null) {
            if (typeof path !== "string" && (typeof path !== "object" || path === null)) {
                throw Error(`Parameter "path" has an invalid type "${typeof path}", the valid type is "string".`);
            }
            try {
                ...
                if (opts != null && opts.chunked === true) {
                    doc = yield this._load_chunked(path, find_opts);
                }
                else {
                    // Load.
                    doc = yield this.col.findOne(typeof path === "object" ? path : { _path: path }, find_opts);
                    this.clean(doc);
                }
                // Process doc.
                ...
                // Insert default keys.
                    ...
                    const set_defaults = (obj, defaults) => {
                        Object.keys(defaults).iterate((key) => {
                            ...
                            else if (typeof obj[key] === "object" && Array.isArray(obj[key]) === false && obj[key] !== null &&
     ...
     *          @type: boolean
     */
    save(path_1, content_1) {
        return __awaiter(this, arguments, void 0, function* (path, content, opts = null) {
            if (typeof path !== "string" && (typeof path !== "object" || path === null)) {
                throw Error(`Parameter "path" has an invalid type "${typeof path}", the valid type is "string".`);
            }
            try {
                ...
                // Save chunked.
                if (opts != null && opts.chunked === true) {
                    yield this._save_chunked(path, set);
                }
                // Save as single doc.
                else {
                    // Apply $set rules.
                    ...
                    // Normal operation.
                        ...
                        yield this.col.updateOne(typeof path === "object" ? path : { _path: path }, set, { upsert: true });
                    }
                }
                // Response.
                return content;
    ...
    list(path_1) {
        return __awaiter(this, arguments, void 0, function* (path, options = {}) {
            ...
            try {
                const docs = yield this.col.find(path, { projection: options.projection }).toArray();
    ...
    list_query() {
        return __awaiter(this, arguments, void 0, function* (query = {}, options = {}) {
            try {
                const docs = yield this.col.find(query, { projection: options.projection }).toArray();
                if (options.process === false) {
                    return docs;
                }
                const result = docs.iterate_append((doc) => this._process_doc(doc)); // list as array since the user might have used a path object width different attributes so dict is not reliable.
    ...
    list_all() {
        return __awaiter(this, arguments, void 0, function* (query = {}, options = {}) {
            let docs;
            if (this.uid_based) {
                docs = yield this.col.find(query, { projection: options.projection }).toArray();
            }
            else {
                docs = yield this.col.find(query, { projection: options.projection }).toArray();
            }
            ...
            try {
                if (opts != null && opts.chunked === true) {
                    if (opts.bulk) {
                        ...
                        yield this.col.deleteMany(typeof path === "object" ? path : { _path: path });
                    }
                }
                else {
                    if (opts != null && opts.bulk) {
                        ...
                        yield this.col.deleteOne(typeof path === "object" ? path : { _path: path });
                    }
                }
            }
            catch (error) {
    ...
    delete_query() {
        return __awaiter(this, arguments, void 0, function* (query = {}) {
            ...
            return yield this.col.deleteMany(query);
        });
    }
    // Delete all.
    delete_all(path) {
     ...
     *      @ignore: true
     */
    delete_recursive(path_1) {
        return __awaiter(this, arguments, void 0, function* (path, uid = null) {
            ...
            try {
                return yield this.col.deleteMany(args);
            }
            catch (error) {
                console.error(error);
                throw new Error('Encountered an error while deleting.');
    ...
    bulk_operations() {
        return __awaiter(this, arguments, void 0, function* (operations = []) {
            return yield this.col.bulkWrite(operations, { ordered: true });
        });
    }
}
// Static attributes.
Collection.chunk_size = 1024 * 1024 * 4; // 4MB chunks, lower is better for frequent updates.
Collection.constructor_scheme = {
    name: "string",
    uid_based: "boolean",
...
*/
class UIDCollection {
    constructor(name, collection, indexes = [], ttl) {
     ...
     */
    create_index(_a) {
        return __awaiter(this, arguments, void 0, function* ({ keys, options = null, commit_quorum = null }) {
            return this._col.createIndex({ keys, options, commit_quorum });
        });
    }
    // Find.
    /*  @docs:
     ...
     */
    find() {
        return __awaiter(this, arguments, void 0, function* (uid = null, query = {}) {
            if (uid != null) {
                query._uid = uid;
            }
            ...
            //     query = uid;
            // }
            return yield this._col.find(query);
        });
    }
    // Exists.
    /*  @docs:
    ...
    exists(uid, path) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof path === "object") {
                return yield this._col.exists(Object.assign(Object.assign({}, path), { _uid: uid }));
            }
            else {
                return yield this._col.exists({ _path: path, _uid: uid });
            }
        });
    }
    // Load.
     ...
     */
    load(uid_1, path_1) {
        return __awaiter(this, arguments, void 0, function* (uid, path, opts = null) {
            if (typeof path !== "string" && (typeof path !== "object" || path === null)) {
                throw Error(`Parameter "path" has an invalid type "${typeof path}", the valid type is "string".`);
            }
            if (typeof uid !== "string") {
            ...
            if (typeof path === "object") {
                return yield this._col.load(Object.assign(Object.assign({}, path), { _uid: uid }), opts);
            }
            else {
                return yield this._col.load({ _path: path, _uid: uid }, opts);
            }
        });
    }
    // Save.
     ...
     *          @type: boolean
     */
    save(uid_1, path_1, content_1) {
        return __awaiter(this, arguments, void 0, function* (uid, path, content, opts = null) {
            if (typeof path !== "string" && (typeof path !== "object" || path === null)) {
                throw Error(`Parameter "path" has an invalid type "${typeof path}", the valid type is "string".`);
            }
            if (typeof uid !== "string") {
            ...
            if (typeof path === "object") {
                return yield this._col.save(Object.assign(Object.assign({}, path), { _uid: uid }), content, opts);
            }
            else {
                return yield this._col.save({ _path: path, _uid: uid }, content, opts);
            }
        });
    }
    // List.
     ...
     */
    list(uid_1, path_1) {
        return __awaiter(this, arguments, void 0, function* (uid, path, options = {}) {
            if (typeof path !== "string" && (typeof path !== "object" || path === null)) {
                throw Error(`Parameter "path" has an invalid type "${typeof path}", the valid type is "string".`);
            }
            if (typeof uid !== "string") {
            ...
            if (typeof path === "object") {
                return yield this._col.list(Object.assign(Object.assign({}, path), { _uid: uid }), options);
            }
            else {
                return yield this._col.list({ _path: path, _uid: uid }, options);
            }
        });
    }
    // List query.
    ...
    list_query() {
        return __awaiter(this, arguments, void 0, function* (query = {}, options = {}) {
            return yield this._col.list_query(query, options);
        });
    }
    // List all.
    /*  @docs:
     ...
     */
    list_all() {
        return __awaiter(this, arguments, void 0, function* (uid = null, options = {}) {
            if (uid == null) {
                return yield this._col.list_all({}, options);
            }
            else {
                return yield this._col.list_all({ _uid: uid }, options);
            }
        });
    }
    // Delete.
    ...
    delete(uid_1, path_1) {
        return __awaiter(this, arguments, void 0, function* (uid, path, opts = null) {
            ...
            if (typeof path === "object") {
                return yield this._col.delete(Object.assign(Object.assign({}, path), { _uid: uid }), opts);
            }
            else {
                return yield this._col.delete({ _path: path, _uid: uid }, opts);
            }
        });
    }
    // Delete.
    ...
    delete_query(query) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this._col.delete_query(query);
        });
    }
    // Delete all.
    /*  @docs:
     ...
     */
    delete_all(uid_1) {
        return __awaiter(this, arguments, void 0, function* (uid, path = null) {
            if (typeof uid !== "string") {
                throw Error(`Parameter "uid" has an invalid type "${typeof uid}", the valid type is "string".`);
            }
            if (path == null) {
                return yield this._col.delete_all({ _uid: uid });
            }
            else if (typeof path === "object") {
                return yield this._col.delete_all(Object.assign(Object.assign({}, path), { _uid: uid }));
            }
            else {
                return yield this._col.delete_all({ _path: path, _uid: uid });
            }
        });
    }
    ...
    delete_recursive(uid, path) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this._col.delete_recursive(path, uid);
        });
    }
    // Delete collection.
    /*  @docs:
    ...
    delete_collection() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this._col.delete_collection();
        });
    }
...
class Database {
    // Constructor.
    constructor({ uri = null, //'mongodb://localhost:27017/main',
    source = null, config = null, start_args = [], client = null, collections = [], uid_collections = [], preview = true, preview_ip_whitelist = [], daemon = {}, _server, }) {
        // Checks.
    ...
    _initialize_db_preview() {
        if (this.preview && this.server.production === false) {
            ...
            // Database preview.
            {
                ...
                view: {
                    callback: () => {
                        vweb.utils.on_load(() => __awaiter(this, void 0, void 0, function* () {
                            // Style theme.   
                            const style = {
                                // bg: "#151721",
                                // sub_bg: "#191B28",
                            ...
                            const collections = (yield vweb.utils.request({ url: "/vweb/db/collections" })).collections;
                            // Render a list.
                            const prev_lists = [];
                            function RenderList({ title, list, doc = null, add_prev = true, }) {
                                if (add_prev) {
                                ...
                                const refresh_obj_view = () => {
                                    obj_view.inner_html("");
                                    let index = 0;
                                    obj_view.append(ForEach(list, (key, value) => {
                                        ++index;
                                        let current_key = key;
                                        ...
                                        // Row.
                                        const row = HStack(key_input, Text(" : ")
                                            .white_space("pre")
                                            .font_family("'Menlo', 'Consolas', monospace")
                                            .color(style.sub_fg)
                                            .font_size(14), value_input, type_select, index < Object.keys(list).length ? null : VStack("add")
                                            .background(style.tag_bg)
                                            .padding(5, 12.5)
                                            .border_radius(10)
                                            .font_size(13)
                                            ...
                                            .margin_left(10)
                                            .border(1, style.div_bg)
                                            .on_click(() => __awaiter(this, void 0, void 0, function* () {
                                        })))
                                            .center_vertical()
                                            .padding(7.5, 0);
                                ...
                                // Add.
                                preview.inner_html("");
                                preview.append(Scroller(VStack(HStack(Title("Database")
                                    .font_family("'Menlo', 'Consolas', monospace")
                                    .font_size(12)
                                    .color(style.tag_fg)
                                    .background(style.tag_bg)
                                    ...
                                    .margin(0, 0, 0, 0)
                                    .border(1, style.div_bg)
                                    .width("fit-content"), Spacer(), doc == null ? null : Button("Update")
                                    .background(style.tag_bg)
                                    .color("#3B8553")
                                    .padding(5, 12.5)
                                    .margin_right(10)
                                    ...
                                    RenderList(Object.assign(Object.assign({}, last), { add_prev: false }));
                                    ...
                                    .font_size(18)
                                    .color(style.fg)
                                    .margin(15, 0), Divider().background(style.div_bg), Array.isArray(list)
                                    ? ForEach(list, (item) => {
                                        return [
                                            VStack(Text(item.__name)
                                                .font_family("'Menlo', 'Consolas', monospace")
                                                .color(style.sub_fg)
                                                .font_size(14)
                                                .on_mouse_over(e => e.color(style.fg))
                            ...
                            // Render a collection.
                            const RenderCollection = (collection) => __awaiter(this, void 0, void 0, function* () {
                                const documents = (yield vweb.utils.request({ url: "/vweb/db/documents", data: { collection } })).documents;
                            ...
                            // Render a document.
                            const RenderDocument = (collection_1, path_1, ...args_1) => __awaiter(this, [collection_1, path_1, ...args_1], void 0, function* (collection, path, uid = null) {
                                let doc = (yield vweb.utils.request({ url: "/vweb/db/document", data: { collection, path, uid } })).document;
            ...
            // Get collections.
            {
                ...
                callback: (stream) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    return stream.success({ data: {
                            ...
                            collections: yield this.get_collections(),
                        } });
                })
            }, 
            ...
            // Get document.
            {
                ...
                callback: (stream, params) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    let doc;
                    if (params.uid == null) {
                        doc = yield col.load(params.path);
                    }
                    else {
                        doc = yield col.load(params.uid, params.path);
                    }
                    // Sign in.
                    return stream.success({ data: {
                            message: "Successfully loaded the document.",
            ...
            // Delete document.
            {
                ...
                callback: (stream, params) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    let doc;
                    if (params.uid == null) {
                        doc = yield col.delete(params.path);
                    }
                    else {
                        doc = yield col.delete(params.uid, params.path);
                    }
                    // Sign in.
                    return stream.success({ data: {
            ...
            // Update document.
            {
                ...
                callback: (stream, params) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    let doc;
                    if (params.uid == null) {
                        doc = yield col.save(params.path, params.content);
                    }
                    else {
                        doc = yield col.save(params.uid, params.path, params.content);
                    }
                    // Sign in.
                    return stream.success({ data: {
    ...
    initialize() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.server.is_primary && this.uri == null) {
                ...
                // Start the database.
                this.proc = libproc.spawn("mongod", ["--config", config_path.str(), ...this.start_args], {
                    // cwd: this.source,
                    stdio: "pipe",
                    detached: true,
    ...
    create_uid_collection({ name, indexes = [], ttl = null }) {
        ...
        const col = new UIDCollection(name, this.db.collection(name), ttl, indexes);
        this.collections[name] = col;
        return col;
    }
    // Get collections.
    ...
    get_collections() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const database = (yield this.db.listCollections().toArray()).iterate_append((item) => { return item.name; });
