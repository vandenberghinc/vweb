...
class Endpoint {
    // Constructor.
    constructor({ method = "GET", endpoint = "/", authenticated = false, rate_limit = null, params = null, callback = null, view = null, data = null, content_type = "text/plain", compress = true, cache = true, ip_whitelist = null, sitemap = null, robots = null, _templates = {}, // only used in loading static files.
    ...
    _refresh(server) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.view !== null) {
                yield this.view._build_html(server, this);
            }
        });
    }
    // Initialize.
    ...
    // Serve a client.
    _serve(stream_1) {
        return __awaiter(this, arguments, void 0, function* (stream, status_code = 200) {
            try {
                // Check IP whitelist.
