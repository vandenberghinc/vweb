...
*/
class Paddle {
    constructor({ api_key, // your private api key.
    client_key, // your public client key.
    sandbox = false, products = [], inclusive_tax = false, _server = null, }) {
        // Verify args.
    ...
    // ---------------------------------------------------------
    // Utils (private).
    _req(method_1, endpoint_1) {
        return __awaiter(this, arguments, void 0, function* (method, endpoint, params = null) {
    ...
    _add_subscription(uid, prod_id, sub_id) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this._active_sub_db.save(uid, prod_id, { prod_id, sub_id });
        });
    }
    _delete_subscription(uid, prod_id) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this._active_sub_db.delete(uid, prod_id);
        });
    }
    _check_subscription(uid_1, prod_id_1) {
        return __awaiter(this, arguments, void 0, function* (uid, prod_id, load_data = true) {
            const doc = yield this._active_sub_db.load(uid, prod_id);
    ...
    _get_active_subscriptions(uid_1) {
        return __awaiter(this, arguments, void 0, function* (uid, detailed = false) {
            const list = yield this._active_sub_db.list_query({ _uid: uid });
            if (detailed) {
                return list;
            }
            const products = [];
    ...
    _save_subscription(subscription) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this._sub_db.save(subscription.uid == null ? "unauth" : subscription.uid, subscription.id, subscription);
        });
    }
    _load_subscription(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const subscription = yield this._sub_db.find(null, { _path: id });
    ...
    _get_subscriptions(uid) {
        return __awaiter(this, void 0, void 0, function* () {
            if (uid === "unauth" || uid == null) {
                return [];
            }
            const list = yield this._sub_db.list_query({ _uid: uid });
            return list;
        });
    }
    ...
    _save_payment(payment) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this._pay_db.save(payment.uid == null ? "unauth" : payment.uid, payment.id, payment);
        });
    }
    _load_payment(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const uid = id.split("_")[1];
            const payment = yield this._pay_db.load(uid, id);
            if (payment == null) {
    ...
    _load_payment_by_transaction(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const payment = yield this._pay_db.find(null, { tran_id: id });
            if (payment == null) {
    ...
    _delete_payment(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const uid = id.split("_")[1];
            yield this._pay_db.delete(uid, id);
        });
    }
    // Delete all info of a user.
    _delete_user(uid) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this._sub_db.delete_all(uid);
            yield this._active_sub_db.delete_all(uid);
            yield this._pay_db.delete_all(uid);
            yield this._inv_db.delete_all(uid);
        });
    }
    // List all active subscriptions.
    _get_all_active_subscriptions() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._active_sub_db.list_query({});
        });
    }
    // ---------------------------------------------------------
    // Overall (private).
    ...
    _get_products() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            while (true) {
                if (next === null) {
                    response = yield this._req("GET", "/products", { status: ["active"], per_page: 100 });
                }
                else {
                    response = yield this._req("GET", next);
                }
    ...
    _get_prices() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            while (true) {
                if (next === null) {
                    response = yield this._req("GET", "/prices", { status: ["active"], per_page: 100 });
                }
                else {
                    response = yield this._req("GET", next);
                }
    ...
    _check_product(product_1) {
        return __awaiter(this, arguments, void 0, function* (product, existing_products = [], existing_prices = []) {
            // Check create product permission.
            const has_create_products_permission = () => __awaiter(this, void 0, void 0, function* () {
                ...
                const input = yield vlib.prompt("Some paddle products have to be edited, do you wish to make these changes? [y/n]: ");
            ...
            if (existing_product == null) {
                // Check permission.
                if (!(yield has_create_products_permission())) {
                    return;
                }
                // Create product.
                logger.log(0, `Creating product ${product.name}.`);
                const created_product = yield this._req("POST", "/products", {
                    name: product.name,
                ...
                const created_price = yield this._req("POST", "/prices", {
            ...
            // Passed an existing product so check.
                ...
                if (update_product) {
                    ...
                    yield this._req("PATCH", `/products/${product.paddle_prod_id}`, {
                        name: product.name,
                        description: product.description,
                        image_url: product.icon,
                        tax_category: product.tax_category,
                ...
                if (existing_price == null) {
                    ...
                    logger.log(0, `Creating a price for product ${product.name}.`);
                    const price = yield this._req("POST", "/prices", {
                        product_id: product.paddle_prod_id,
                        name: product.name,
                        description: product.description,
                        unit_price: { amount: parseInt(product.price * 100).toString(), currency_code: product.currency },
                ...
                // Update price.
                    ...
                    if (update_price) {
                        ...
                        yield this._req("PATCH", `/prices/${product.price_id}`, {
    ...
    _cancel_subscription(id_1) {
        return __awaiter(this, arguments, void 0, function* (id, immediate = false) {
            if (id == null) {
                throw Error(`Define parameter \"id\".`);
            }
            // Load subscription object.
            const subscription = yield this._load_subscription(id);
            if (subscription == null) {
                throw Error(`Unable to find subscription "${id}".`);
            }
            // Cancel.
            ...
            yield this._req("POST", `/subscriptions/${subscription.id}/cancel`, {
                effective_from: immediate ? "immediately" : null,
            });
            // Update subscription.
            subscription.status = "cancelling";
            yield this._save_subscription(subscription);
        });
    }
    ...
    _initialize_products() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const last_products = yield this._settings_db.load(`last_products${this.server.production ? "" : "_demo"}`);
            if (Object.eq(last_products, this.products)) {
                const product_ids = yield this._settings_db.load(`product_ids${this.server.production ? "" : "_demo"}`);
                ...
                const existing_products = yield this._get_products();
                const existing_prices = yield this._get_prices();
                /* @performance */ now = this.performance.end("get-prices-and-products", now);
                // Check all products.
                const product_ids = [];
                yield this.products.iterate_async_await((product) => __awaiter(this, void 0, void 0, function* () {
                    if (product.plans != null) {
                        yield product.plans.iterate_async_await((plan) => __awaiter(this, void 0, void 0, function* () {
                            yield this._check_product(plan, existing_products, existing_prices);
                            product_ids.append({
                                id: plan.id,
                        ...
                        yield this._check_product(product, existing_products, existing_prices);
                        product_ids.append({
                            id: product.id,
                ...
                // Save last products.
                yield this._settings_db.save(`last_products${this.server.production ? "" : "_demo"}`, Object.delete_recursively(Object.deep_copy(this.products), ["paddle_prod_id", "price_id"]));
                // Save price ids.
                yield this._settings_db.save(`product_ids${this.server.production ? "" : "_demo"}`, product_ids);
    ...
    _initialize() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // Initialize products.
            yield this._initialize_products();
            /* @performance */ let now = this.performance.start();
            // Add endpoints.
            ...
            // Initialize and verify an order, check if the user is authenticated when subscriptions are present and check if the user is not already subscribed to the same item.
            {
                ...
                callback: (stream, params) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    let sub_plan_count = {};
                    const error = yield params.items.iterate_async_await((item) => __awaiter(this, void 0, void 0, function* () {
                        if (item.product.is_subscription) {
                            ...
                            if (yield this._check_subscription(stream.uid, item.product.id, false)) {
            ...
            // Get payment by id.
            {
                ...
                callback: (stream, params) => __awaiter(this, void 0, void 0, function* () {
                    return stream.success({ data: (yield this._load_payment(params.id)) });
                })
            }, 
            // Get payments.
            {
                ...
                callback: (stream, params) => __awaiter(this, void 0, void 0, function* () {
                    const result = yield this.get_payments({
                        uid: stream.uid,
                        days: params.days,
                        limit: params.limit,
            ...
            // Get refundable payments.
            {
                ...
                callback: (stream, params) => __awaiter(this, void 0, void 0, function* () {
                    const result = yield this.get_refundable_payments({
                        uid: stream.uid,
                        days: params.days,
                        limit: params.limit,
                    });
            ...
            // Get refunded payments.
            {
                ...
                callback: (stream, params) => __awaiter(this, void 0, void 0, function* () {
                    const result = yield this.get_refunded_payments({
                        uid: stream.uid,
                        days: params.days,
                        limit: params.limit,
                    });
            ...
            // Get refunding payments.
            {
                ...
                callback: (stream, params) => __awaiter(this, void 0, void 0, function* () {
                    const result = yield this.get_refunding_payments({
                        uid: stream.uid,
                        days: params.days,
                        limit: params.limit,
                    });
            ...
            // Create a refund.
            {
                ...
                callback: (stream, params) => __awaiter(this, void 0, void 0, function* () {
                    yield this.create_refund(params.payment, params.line_items, params.reason);
            ...
            // Cancel a subscription.
            {
                ...
                callback: (stream, params) => __awaiter(this, void 0, void 0, function* () {
                    yield this.cancel_subscription(stream.uid, params.product);
                    return stream.success();
                })
            }, 
            ...
            // Get active subscriptions.
            {
                ...
                callback: (stream, params) => __awaiter(this, void 0, void 0, function* () {
                    return stream.success({
                        data: { subscriptions: (yield this.get_active_subscriptions(stream.uid)) },
                    });
                })
            }, 
            // Is subscribed
            {
                ...
                callback: (stream, params) => __awaiter(this, void 0, void 0, function* () {
                    return stream.success({
                        data: { is_subscribed: (yield this.is_subscribed(stream.uid, params.product)) }
                    });
                })
            }, 
            // Webhook.
            this.server.offline ? null : (yield this._create_webhook()));
    ...
    _exec_user_callback(callback, args) {
        return __awaiter(this, void 0, void 0, function* () {
            if (callback != null) {
                try {
    ...
    _payment_webhook(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // Make request.
            let obj = (yield this._req("GET", `/transactions/${data.id}`, { include: ["address", "adjustment", "business", "customer"] })).data;
            // Initialize.
            ...
            yield this._save_payment(payment);
            // ---------------------------------------------------------
            // Process the payment.
            const { uid, cus_id } = payment;
            // Check the payment line items.
            yield payment.line_items.iterate_async_await((item) => __awaiter(this, void 0, void 0, function* () {
                ...
                // Subscription.
                    ...
                    const subscription = yield this.get_product(product.subscription_id, true);
                    yield subscription.plans.iterate_async_await((plan) => __awaiter(this, void 0, void 0, function* () {
                        if (plan.id != product.id) {
                            const { exists, sub_id } = yield this._check_subscription(uid, plan.id);
                            if (exists) {
                                ...
                                yield this._cancel_subscription(sub_id);
                            }
                        }
                    }));
                ...
                // One time payment.
                    ...
                    // Execute callback.
                    yield this._exec_user_callback(this.server.on_payment, { product, payment });
                }
            }));
    ...
    _subscription_webhook(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield data.items.iterate_async_await((item) => __awaiter(this, void 0, void 0, function* () {
                ...
                // Subscription.
                    ...
                    yield this._add_subscription(uid, product.id, subscription.id);
                    // No need to cancel other subs, this is already handled by the payment webhook.
                    // Execute callback.
                    yield this._exec_user_callback(this.server.on_susbcription, { product, subscription });
                }
            }));
            // Save subscription.
            yield this._save_subscription(subscription);
    ...
    _subscription_cancelled_webhook(data) {
        return __awaiter(this, void 0, void 0, function* () {
            // Vars.
            const subscription = yield this._load_subscription(data.id);
            // Delete subscriptions made by this subscription.
            yield subscription.plans.iterate_async_await((plan_id) => __awaiter(this, void 0, void 0, function* () {
                yield this._delete_subscription(subscription.uid, plan_id);
            ...
            yield this._save_subscription(subscription);
            // Execute callback.
            yield this._exec_user_callback(this.server.on_cancellation, { subscription });
            // Send an email to the user.
            // try {
            //     await this._send_payment_mail({
            //         payment, 
    ...
    _adjustment_webhook(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (is_refund || is_chargeback) {
                ...
                // Vars.
                const payment = yield this._load_payment_by_transaction(data.transaction_id);
                ...
                if (payment.sub_id != null && is_approved) {
                    yield this._cancel_subscription(payment.sub_id, true);
                }
                // Update database.
                ...
                if (is_approved) {
                    ...
                    yield this._exec_user_callback(is_refund ? this.server.on_refund : this.server.on_chargeback, { payment, line_items });
                    // try {
                    //     await this._send_payment_mail({
                    //         payment, 
                    ...
                    yield this._exec_user_callback(is_refund ? this.server.on_failed_refund : this.server.on_failed_chargeback, { payment, line_items });
                    // try {
                    //     await this._send_payment_mail({
                    //         payment, 
    ...
    _create_webhook() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const webhook_doc = yield this._settings_db.load(`webhook${this.server.production ? "" : "_demo"}`);
            ...
            // Register webhook.
            const register_webhook = () => __awaiter(this, void 0, void 0, function* () {
                logger.log(0, "Registering payments webhook.");
                const response = yield this._req("POST", "/notification-settings", webhook_settings);
                this.webhook_key = response.data.endpoint_secret_key;
                yield this._settings_db.save(`webhook${this.server.production ? "" : "_demo"}`, {
                    id: response.data.id,
            ...
            if (webhook_doc != null) {
                ...
                const last_webhook = yield this._settings_db.load(`last_webhook${this.server.production ? "" : "_demo"}`);
                if (last_webhook !== this.server.hash(webhook_settings) && file_watcher_restart === false) {
                    logger.log(0, `Checking payments webhook.`);
                    // Check update required.
                    const webhook_id = webhook_doc.id;
                    let registered;
                    try {
                        registered = yield this._req("GET", `/notification-settings/${webhook_id}`);
                    }
                    catch (error) {
                        if (error.status === 404) {
                            registered = undefined;
                            yield register_webhook();
                        }
                        else {
                            throw error;
                        }
                    ...
                    if (registered) {
                        ...
                        if (patch === true) {
                            ...
                            yield this._req("PATCH", `/notification-settings/${webhook_id}`, Object.assign(Object.assign({}, webhook_settings), { active: true }));
                        }
                        // Save.
                        yield this._settings_db.save(`last_webhook${this.server.production ? "" : "_demo"}`, this.server.hash(webhook_settings));
                    }
                }
            }
            // Register webhook.
                ...
                callback: (stream) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    switch (event.event_type) {
                        ...
                        case "transaction.paid":
                            yield this._payment_webhook(event.data);
                            break;
                        // Subscription activated.
                        ...
                        case "subscription.resumed":
                            yield this._subscription_webhook(event.data);
                            break;
                        // Subscription canceled.
                        // https://developer.paddle.com/webhooks/subscriptions/subscription-canceled
                        case "subscription.canceled":
                        case "subscription.paused":
                            yield this._subscription_cancelled_webhook(event.data);
                            break;
                        // Adjustment updated (refunds).
                        // https://developer.paddle.com/webhooks/subscriptions/subscription-canceled
                        case "adjustment.updated":
                            yield this._adjustment_webhook(event.data);
                            break;
                        // Default.
                        default: break;
                    }
     ...
     */
    get_product(id_1) {
        return __awaiter(this, arguments, void 0, function* (id, throw_err = false) {
    ...
    */
    get_payment(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._load_payment(id);
        });
    }
    // Get payments.
    /*  @docs:
    ...
    */
    get_payments(_a) {
        return __awaiter(this, arguments, void 0, function* ({ uid, days = 30, limit = null, status = null, }) {
            // Get path.
            const list = yield this._pay_db.list_query({ _uid: uid });
            // Get the since time.
            let since = null;
            if (days != null) {
                since = new Date();
    ...
    /*  @docs:
        ...
        @param:
            ...
            @desc: Limit the amount of response payment objects.
    */
    get_refundable_payments(_a) {
        return __awaiter(this, arguments, void 0, function* ({ uid, days = 30, limit = null, }) {
            const payments = [];
            const all_payments = yield this.get_payments({ uid, days, limit, status: "paid" });
    ...
    */
    ...
    /*  @docs:
        ...
        @param:
            ...
            @desc: Limit the amount of response payment objects.
    */
    get_refunding_payments(_a) {
        return __awaiter(this, arguments, void 0, function* ({ uid, days = null, limit = null, }) {
            const payments = [];
            const all_payments = yield this.get_payments({ uid, days, limit, status: "paid" });
            all_payments.iterate((payment) => {
                const line_items = [];
    ...
    */
    create_refund(payment_1) {
        return __awaiter(this, arguments, void 0, function* (payment, line_items = null, reason = "refund") {
            // Load payment.
            ...
            if (typeof payment === "string") {
                payment = yield this._load_payment(payment);
            }
            else {
                payment = yield this._load_payment(payment.id);
            }
            ...
            // Make request.
            const response = yield this._req("POST", `/adjustments`, {
                action: "refund",
    ...
    */
    cancel_subscription(uid_1, products_1) {
        return __awaiter(this, arguments, void 0, function* (uid, products, _throw_no_cancelled_err = true) {
            if (products == null) {
            ...
            let cancelled = [];
            yield products.iterate_async_await((product) => __awaiter(this, void 0, void 0, function* () {
                if (typeof product === "object") {
                    product = product.id;
                }
                const { exists, sub_id } = yield this._check_subscription(uid, product);
    ...
    */
    cancel_subscription_by_id(subscription_1) {
        return __awaiter(this, arguments, void 0, function* (subscription, immediate = false) {
            if (typeof subscription === "object") {
                subscription = subscription.id;
            }
            return yield this._cancel_subscription(subscription, immediate);
        });
    }
    // Get subscriptioms.
    /*  @docs:
        ...
        @param:
            ...
            @cached: Users:uid:param
    */
    get_active_subscriptions(uid) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._get_active_subscriptions(uid);
        });
    }
    /*  @docs:
    ...
    */
    get_subscriptions(uid) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._get_subscriptions(uid);
        });
    }
    // Is subscribed.
    /*  @docs:
        ...
        @param:
            ...
            @desc: The product id.
    */
    is_subscribed(uid, product) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._check_subscription(uid, product, false);
        });
    }
    // Generate an invoice.
    /*  @docs:
    ...
    */
    ...
    dev_cancel_all_subscriptions() {
        return __awaiter(this, void 0, void 0, function* () {
            // Fetch.
            let subs = [], after = null;
            while (true) {
                const response = yield this._req("GET", "/subscriptions", after == null ? { per_page: 100 } : { per_page: 100, after });
            ...
            // Cancel.
            yield subs.iterate_async_await((sub) => __awaiter(this, void 0, void 0, function* () {
                if (sub.status === "active") {
                    console.log("Cancelling subscription", sub.id);
                    yield this._req("POST", `/subscriptions/${sub.id}/cancel`, {
                        effective_from: "immediately",
                    });
                }
            }));
