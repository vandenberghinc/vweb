...
// Element.
function CreateVElementClass({ type = "VElement", tag = "div", default_style = null, default_attributes = null, default_events = null, }) {
    // The class.
    class E {
        // ---------------------------------------------------------
        // Constructor.
    ...
    // ---------------------------------------------------------
    // Attributes.
    E.element_tag = tag; // must remain static.
    E.default_style = default_style;
    E.default_attributes = default_attributes;
    E.default_events = default_events;
    return E;
}
