...
function CreateVElementClass({ type, is_text = false, is_img = false, is_hstack = false, is_stack = false, }) {
    class E {
        ...
        _compute(doc, x, y, page, refresh = false) {
            ...
            if (!is_absolute && computed.resume_y > doc._vweb_page_height - doc._vweb_margin_bottom &&
                ...
                if (this.is_text) {
                    ...
                    if (computed.padding_start_y + dimensions.h > doc._vweb_page_height - doc._vweb_margin_bottom) {
                        this._restore_styling(doc);
                    ...
                    for (let i = 0; i < 100000; i++) {
                        ...
                        // Recompute.
                        // process.exit(0)
                        copy._compute(doc, i === 0 ? computed.start_x : this._parent._wrap_x, i === 0 ? computed.start_y : doc._vweb_margin_top, child_page, true);
                        // Append.
...
// ---------------------------------------------------------
// Code block.
PDF.CodeBlockElement = (_a = class CodeBlockElement extends CreateVElementClass({
        type: "CodeBlock",
        is_stack: true,
    }) {
        // Constructor.
        ...
        _initialize() {
            ...
            // Create children.
            this._children = [];
            this._children.append(_a.build_tokens(tokens));
            // Initialized.
