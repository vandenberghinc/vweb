...
export class ImageElement extends ImageElement_base {
    ...
    constructor(src: any, alt: any);
    _e: HTMLImageElement | undefined;
    set_default(): this;
    src(value: any): string | this;
    src(value: any): string | this;
    alt(value: any): string | this;
    completed(value: any): any;
    height(value: any, check_attribute?: boolean): number | this;
    min_height(value: any): string | this;
    max_height(value: any): string | this;
    width(value: any, check_attribute?: boolean): number | this;
    min_width(value: any): string | this;
    max_width(value: any): string | this;
    loading(value: any): "eager" | "lazy" | this | ((value: any) => "eager" | "lazy" | this | any);
}
export const Image: (...args: any[]) => any;
export class AnchorImageElement {
    static default_style: any;
    constructor(href: any, src: any, alt: any);
    image: any;
    set_default(): any;
    src(value: any): any;
    src(value: any): any;
    alt(value: any): any;
    completed(value: any): any;
    height(value: any, ...args: any[]): any;
    min_height(value: any): any;
    max_height(value: any): any;
    width(value: any, ...args: any[]): any;
    min_width(value: any): any;
    max_width(value: any): any;
    loading(value: any): any;
}
export const AnchorImage: (...args: any[]) => any;
...
export class ImageMaskElement extends ImageMaskElement_base {
    ...
    color(value: any): any;
    transition_mask(value: any): any;
    src(value: any): any;
    _src: any;
    mask(value: any): any;
}
export const ImageMask: (...args: any[]) => any;
declare const AnchorImageMaskElement_base: {
    new (): {
        [x: string]: any;
        __is_velement: boolean;
        rendered: boolean;
...
export class AnchorImageMaskElement extends AnchorImageMaskElement_base {
    constructor(src: any);
    mask_child: any;
    mask_color(value: any): any;
    color(value: any): any;
...
export const AnchorImageMask: (...args: any[]) => any;
export {};
