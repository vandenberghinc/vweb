declare const InputElement_base: {
    new (): {
        [x: string]: any;
...
export class InputElement extends InputElement_base {
    constructor(placeholder: any, type?: string, value?: null);
    _e: HTMLInputElement | undefined;
    value(val: any): string | this;
    required(val: any): boolean | this;
    type(val: any): string | this;
    placeholder(val: any): string | this;
    resize(val: any): any;
    padding(...values: any[]): string | this;
}
export const Input: (...args: any[]) => any;
declare const InputBoxElement_base: {
    new (): {
        [x: string]: any;
        __is_velement: boolean;
        rendered: boolean;
...
export class InputBoxElement extends InputBoxElement_base {
    constructor(placeholder: any);
    _e: HTMLTextAreaElement | undefined;
    value(val: any): string | this;
    required(val: any): boolean | this;
    type(val: any): string | this;
    placeholder(val: any): string | this;
...
export const InputBox: (...args: any[]) => any;
export class ExtendedInputElement {
    ...
    missing(to?: null, err?: string): boolean | this;
    set_error(err?: string): boolean | this;
    submit(): any;
    mask_color(val: any): any;
    show_error(err?: string): this;
    hide_error(): this;
    text(val: any): any;
    value(val: any): any;
    required(val: any): any;
    on_enter(val: any): any;
    on_input(val: any): any;
    border_radius(val: any): any;
    border_color(val: any): any;
    border_width(val: any): any;
    border_style(val: any): any;
    background(val: any): any;
    padding(...args: any[]): any;
    border(...args: any[]): any;
}
export const ExtendedInput: (...args: any[]) => any;
export class ExtendedSelectElement {
    static default_style: any;
    ...
    error: any;
    dropdown: any;
    _on_dropdown_close: (event: any) => void;
    dropdown_height(val: any): any;
    _dropdown_height: any;
    styles(style_dict: any): any;
    set_default(): any;
    focus_color(val: any): any;
    missing_color(val: any): any;
    ...
    padding(...args: any[]): any;
    border(...args: any[]): any;
    on_change(callback: any): any;
    _on_change_callback: any;
    text(val: any): any;
    required(val: any): any;
}
export const ExtendedSelect: (...args: any[]) => any;
export {};
