...
export declare const Gradient: (...args: any[]) => any;
declare const GradientBorderElement_base: {
    new (): {
        [x: string]: any;
        ...
        color(): string;
        color(value: string | GradientType): any;
        border(): string;
...
export declare class GradientBorderElement extends GradientBorderElement_base {
...
export declare const GradientBorder: (...args: any[]) => any;
export {};
