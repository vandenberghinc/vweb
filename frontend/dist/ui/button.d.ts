...
declare const BorderButtonElement_base: {
    new (): {
        [x: string]: any;
        __is_velement: boolean;
        rendered: boolean;
 ...
 */
export declare class BorderButtonElement extends BorderButtonElement_base {
    nodes: {
        border: VDivElement;
        text: VDivElement;
        [key: string]: any;
...
export declare const BorderButton: (...args: any[]) => any;
/**
...
export declare const LoaderButton: (...args: any[]) => any;
export {};
