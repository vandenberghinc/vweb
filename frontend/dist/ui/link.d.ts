declare const AnchorElement_base: {
    new (): {
        [x: string]: any;
...
export declare class AnchorElement extends AnchorElement_base {
    constructor(href: string, alt: string, text?: string);
}
export declare const Anchor: (...args: any[]) => any;
declare const LinkElement_base: {
    new (): {
        [x: string]: any;
        __is_velement: boolean;
        rendered: boolean;
...
export declare class LinkElement extends LinkElement_base {
    constructor(text: string, href: string);
}
export declare const Link: (...args: any[]) => any;
export {};
