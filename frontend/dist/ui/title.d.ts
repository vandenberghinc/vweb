...
export declare class TitleElement extends TitleElement_base {
    constructor(text: string);
}
export declare const Title: (...args: any[]) => any;
...
export declare class SubtitleElement extends SubtitleElement_base {
    constructor(text: string);
}
export declare const Subtitle: (...args: any[]) => any;
export {};
