declare const PseudoElement_base: {
    new (): {
        [x: string]: any;
...
export class PseudoElement extends PseudoElement_base {
    constructor(...children: any[]);
    added_to_elements: any[];
    update(): this;
}
export const Pseudo: (...args: any[]) => any;
export {};
