...
function CreateVElementClass({
    ...
    class E {
        ...
        static is_text = is_text;
        static is_img = is_img;
        ...
        */
        ...
        _compute(doc, x, y, page, refresh = false) {
            ...
            if (
                !is_absolute && computed.resume_y > doc.page.height - doc.page.margins.bottom &&
                ...
                if (E.is_text) {
                    ...
                    for (let i = 0; i < 100000; i++) {
                        ...
                        copy._compute(
                            ...
                            i === 0 ? computed.start_y : doc.page.margins.top, 
                            child_page,
                            true,
                        );
        ...
        // Width.
        width(val) {
            if (val == undefined) { return this._style.width; }
            if (PDF.use_pixels) { val = this._px(val); }
        ...
        // Height.
        height(val) {
            if (val == undefined) { return this._style.height; }
        ...
        // Font family.
        font_family(val) {
            if (val === undefined) { return this._style.font; }
        ...
        // Font size.
        font_size(val) {
            if (val === undefined) { return this._calls.fontSize; }
            if (PDF.use_pixels) { val = this._px(val); }
        ...
        ellipsis_overflow(value) {
            if (value === undefined) { return this._style.ellipsis; }
        ...
        // Line height.
        line_height(val) {
            if (val === undefined) { return this._style.lineGap; }
            if (PDF.use_pixels) { val = this._px(val); }
        ...
        // Word spacing.
        word_spacing(val) {
            if (val === undefined) { return this._style.wordSpacing; }
            if (PDF.use_pixels) { val = this._px(val); }
        ...
        // Align.
        align(val) {
            if (val === undefined) { return this._style.align; }
        ...
        align_vertical(val) {
            if (val === undefined) { return this._style.valign; }
        ...
        fit(width, height) {
            if (width === undefined) { return this._style.fit; }
            if (PDF.use_pixels) {
        ...
        position(...values) {
            if (values.length === 0) {
                ...
                if (PDF.use_pixels) { values[0] = this._px(values[0]); }
                ...
                if (values[1] != null) {
                    if (PDF.use_pixels) { values[1] = this._px(values[1]); }
                    this._position[1] = values[1];
                }
                if (values[2] != null) {
                    if (PDF.use_pixels) { values[2] = this._px(values[2]); }
                    this._position[2] = values[2];
                }
                if (values[3] != null) {
                    if (PDF.use_pixels) { values[3] = this._px(values[3]); }
        ...
        // Color.
        color(val) {
            if (val === undefined) { return this._calls.fillColor; }
        ...
        // Underine (boolean).
        underline(val) {
            if (val === undefined) { return this._style.underline; }
        ...
        // strike (boolean).
        strike(val) {
            if (val === undefined) { return this._style.strike; }
