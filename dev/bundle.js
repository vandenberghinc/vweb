...
const embed_script = (input, output) => {
    ...
    data = `/* DO NOT EDIT THIS FILE IT IS LOCATED AT ${input}. */ \n` + data;
...
embed_script(`${process.env.PERSISTANCE}/private/dev/vinc/vlib/js/include/types/system/colors.js`, frontend+"/modules/colors.js")

// Compile vweb.js.
const version = JSON.parse(new vlib.Path(`${__dirname}/../js/package.json`).load_sync()).version;
