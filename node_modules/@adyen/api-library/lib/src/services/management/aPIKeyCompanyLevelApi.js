...
exports.APIKeyCompanyLevelApi = void 0;
const getJsonResponse_1 = __importDefault(require("../../helpers/getJsonResponse"));
const service_1 = __importDefault(require("../../service"));
const resource_1 = __importDefault(require("../resource"));
const models_1 = require("../../typings/management/models");
class APIKeyCompanyLevelApi extends service_1.default {
    constructor(client) {
        super(client);
    ...
    */
    async generateNewApiKey(companyId, apiCredentialId, requestOptions) {
        ...
        return models_1.ObjectSerializer.deserialize(response, "GenerateApiKeyResponse");
    }
}
exports.APIKeyCompanyLevelApi = APIKeyCompanyLevelApi;
//# sourceMappingURL=aPIKeyCompanyLevelApi.js.map