...
export declare class TerminalSettingsCompanyLevelApi extends Service {
    ...
    * @return {@link Logo }
    */
    getTerminalLogo(companyId: string, requestOptions?: IRequest.Options): Promise<Logo>;
    /**
    ...
    */
    getTerminalSettings(companyId: string, requestOptions?: IRequest.Options): Promise<TerminalSettings>;
    /**
    ...
    * @return {@link Logo }
    */
    updateTerminalLogo(companyId: string, logo: Logo, requestOptions?: IRequest.Options): Promise<Logo>;
    /**
    ...
    * @return {@link TerminalSettings }
    */
    updateTerminalSettings(companyId: string, terminalSettings: TerminalSettings, requestOptions?: IRequest.Options): Promise<TerminalSettings>;
}
