...
export declare class StoredValueStatusChangeResponse {
    /**
    ...
    */
    'resultCode'?: StoredValueStatusChangeResponse.ResultCodeEnum;
    /**
...
export declare namespace StoredValueStatusChangeResponse {
    enum ResultCodeEnum {
        Success = "Success",
        Refused = "Refused",
        Error = "Error",
